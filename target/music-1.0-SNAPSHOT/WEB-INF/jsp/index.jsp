	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <form class="form-signin" id="register-submit">
		      <!-- <img class="mb-4" src="https://getbootstrap.com/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72"> -->
		      <h1 class="h3 mb-3 font-weight-normal">请输入帐号和密码</h1>
				<%--这个地方有bug，邮箱验证一直不成功，可能是因为内网无法直接渗透到外网--%>
		      <label for="inputEmail" class="sr-only">Email address</label>
 ...
 oninput="setCustomValidity('')">
    ...
    <div id="hot">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle" src="${pageContext.request.contextPath}/image/3.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>热门推荐</h2>
            <p>聆听潮流的声音</p>
